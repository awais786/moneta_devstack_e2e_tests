...
// Penpot's UI (dashboard + settings) uses listitem/button click handlers,
// not <a href> tags — anchor-based discovery doesn't apply. L1 still
// enforces a sane start URL; L2–L7 self-skip.
